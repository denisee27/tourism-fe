...
import { useToasts, useUIStore } from "../../../core/stores/uiStore";
 ...
 *
 * Usage:
 * Add this component to your app root (already in AppProviders):
 * <ToastContainer />
 *
...
const Toast = ({ toast }) => {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleClose}
        className="flex-shrink-0 inline-flex text-current hover:opacity-70 transition-opacity"
        aria-label="Close"
      >
